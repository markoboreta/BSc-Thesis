...
# classes for unit testing the application
app_classes = {
...
app_configs = {
    "LRApp": {
        "client_app": "app",
        "base_url": "/predict_LR",
        "patch_base": "prediciton_services_LR.LR.LRModel.predict_news_article",
    ...
    "NBApp": {
        "client_app": "app",
        "base_url": "/predict_NB",
        "patch_base": 'prediction_services_NB.NB.NBModel.predict_news_article',
    ...
    "PAApp": {
        "client_app": "app",
        "base_url": "/predict_PA",
        "patch_base": 'prediction_services_PA.PA.PAModel.predict_news_article',
        "patch_api_url_1": 'common.classes.class_service.service_api.PredictLR.post',
